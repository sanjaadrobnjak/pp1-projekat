...
public class IfCondElseStmt extends Statement {

    private Condition Condition;
    private Statement Statement;
    private ElseStatement ElseStatement;

    public IfCondElseStmt (Condition Condition, Statement Statement, ElseStatement ElseStatement) {
